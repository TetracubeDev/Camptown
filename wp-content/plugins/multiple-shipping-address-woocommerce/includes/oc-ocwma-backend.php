                    ...
                    <div class="ocwma_cover_div">
                        <table class="ocwma_data_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="ocwma_comman[ocwma_enable_multiple_billing_adress]" class="ocwma_enable_multi_bill_adress" value="yes" <?php if ($ocwma_comman['ocwma_enable_multiple_billing_adress'] == 'yes') {
                                                                                                                                                                            echo "checked";
                                                                                                                                                                        } ?>>
                                </td>
                            </tr>
                            ...
                            <tr class="billing_address_setting">
                                ...
                                <td>
                                    <select name="ocwma_comman[ocwma_select_address_type]" class="regular-text">
                                        <option value="Dropdown" <?php if ($ocwma_comman['ocwma_select_address_type'] == 'Dropdown') {
                                                                        echo "selected";
                                                                    } ?>><?php echo esc_html_e('Dropdown', 'multiple-shipping-address-woocommerce'); ?></option>
                                        <option value="Popup" <?php if ($ocwma_comman['ocwma_select_address_type'] == 'Popup') {
                                                                    echo "selected";
                                                                } ?>><?php echo esc_html_e('Popup', 'multiple-shipping-address-woocommerce'); ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr class="billing_address_setting">
                                ...
                                <td>
                                    <select name="ocwma_comman[ocwma_select_address_position]" class="regular-text">
                                        <option value="billing_before_form_data" <?php if ($ocwma_comman['ocwma_select_address_position'] == 'billing_before_form_data') {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo esc_html_e('Before Billing Form Data', 'multiple-shipping-address-woocommerce'); ?></option>
                                        <option value="billing_after_form_data" <?php if ($ocwma_comman['ocwma_select_address_position'] == 'billing_after_form_data') {
                                                                                    echo "selected";
                                                                                } ?>><?php echo esc_html_e('After Billing Form Data', 'multiple-shipping-address-woocommerce'); ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr class="billing_address_setting">
                                ...
                                <td>
                                    <select name="ocwma_comman[ocwma_select_popup_btn_style]" class="regular-text">
                                        <option value="button" <?php if ($ocwma_comman['ocwma_select_popup_btn_style'] == 'button') {
                                                                    echo "selected";
                                                                } ?>><?php echo esc_html_e('Button', 'multiple-shipping-address-woocommerce'); ?></option>
                                        <option value="link" <?php if ($ocwma_comman['ocwma_select_popup_btn_style'] == 'link') {
                                                                    echo "selected";
                                                                } ?>><?php echo esc_html_e('Link', 'multiple-shipping-address-woocommerce'); ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr class="billing_address_setting">
                    ...
                    <div class="ocwma_cover_div">
                        <table class="ocwma_data_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="ocwma_comman[ocwma_enable_multiple_shipping_adress]" class="ocwma_enable_multi_ship_adress" value="yes" <?php if ($ocwma_comman['ocwma_enable_multiple_shipping_adress'] == 'yes') {
                                                                                                                                                                                echo "checked";
                                                                                                                                                                            } ?>>
                                </td>
                            </tr>
                            ...
                            <tr class="shipping_address_setting">
                                ...
                                <td>
                                    <select name="ocwma_comman[ocwma_select_shipping_address_type]" class="regular-text">
                                        <option value="Dropdown" <?php if ($ocwma_comman['ocwma_select_shipping_address_type'] == 'Dropdown') {
                                                                        echo "selected";
                                                                    } ?>><?php echo esc_html_e('Dropdown', 'multiple-shipping-address-woocommerce'); ?></option>
                                        <option value="Popup" <?php if ($ocwma_comman['ocwma_select_shipping_address_type'] == 'Popup') {
                                                                    echo "selected";
                                                                } ?>><?php echo esc_html_e('Popup', 'multiple-shipping-address-woocommerce'); ?></option>
                                    </select>
                                </td>
                            ...
                            <tr class="shipping_address_setting">
                                ...
                                <td>
                                    <select name="ocwma_comman[ocwma_select_shipping_address_position]" class="regular-text">
                                        <option value="shipping_before_form_data" <?php if ($ocwma_comman['ocwma_select_shipping_address_position'] == 'shipping_before_form_data') {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo esc_html_e('Before Shipping Form Data', 'multiple-shipping-address-woocommerce'); ?></option>
                                        <option value="shipping_after_form_data" <?php if ($ocwma_comman['ocwma_select_shipping_address_position'] == 'shipping_after_form_data') {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo esc_html_e('After Shipping Form Data', 'multiple-shipping-address-woocommerce'); ?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr class="shipping_address_setting">
                                ...
                                <td>
                                    <select name="ocwma_comman[ocwma_shipping_select_popup_btn_style]" class="regular-text">
                                        <option value="button" <?php if ($ocwma_comman['ocwma_shipping_select_popup_btn_style'] == 'button') {
                                                                    echo "selected";
                                                                } ?>><?php echo esc_html_e('Button', 'multiple-shipping-address-woocommerce'); ?></option>
                                        <option value="link" <?php if ($ocwma_comman['ocwma_shipping_select_popup_btn_style'] == 'link') {
                                                                    echo "selected";
                                                                } ?>><?php echo esc_html_e('Link', 'multiple-shipping-address-woocommerce'); ?></option>
                                    </select>
                                </td>
