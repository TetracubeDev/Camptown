...
1. Upload the folder 'woo-ajax-loginregister` to the `/wp-content/plugins/` folder
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Without any setting you can easily use functionality of this plugin in WooCommerce login and register form.
