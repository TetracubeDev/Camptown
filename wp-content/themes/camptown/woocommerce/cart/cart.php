...
<div class="row">
			...
			<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
				<thead>
					<tr>
						...
						<th class="product-remove"> הסר מוצר </th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="cart-button">
						<td colspan="6" class="actions">
							...
							<button type="submit" class="button alternative-btn update-cart" name="update_cart" value="<?php esc_attr_e('Update cart', 'woocommerce'); ?>"><i class="icon-update"></i> <?php esc_html_e('Update cart', 'woocommerce'); ?></button>
	...
	<div class="col-12 col-lg-4">
		...
		<?php if (get_field('payment_info')) { ?>
			<div class="additional-info">
				<?php the_field('payment_info'); ?>
			</div>
		<?php } ?>
	</div>
</div>
