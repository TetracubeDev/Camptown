...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="modal__text text-center"><?php echo apply_filters('woocommerce_lost_password_message', esc_html__('אין בעיה. רשמו כתובת מייל ונשלח אליכם לינק לאיפוס סיסמה', 'woocommerce')); ?></p><?php // @codingStandardsIgnoreLine 
																																					?>
