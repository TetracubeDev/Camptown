...
<?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
	...
	<form class="woocommerce-form woocommerce-form-login login active" method="post">
		...
		<p class="login-modal__email">
			<input type="text" placeholder='* כתובת דוא"ל' class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" autocomplete="username" value="<?php echo (!empty($_POST['username'])) ? esc_attr(wp_unslash($_POST['username'])) : ''; ?>" /><?php // @codingStandardsIgnoreLine 
																																																																					?>
		</p>
		...
		<p class="login-modal__checkbox">
			<label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
				<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" checked="checked" id="rememberme" value="forever" /> <span><?php esc_html_e('Remember me', 'woocommerce'); ?></span>
			</label>
	...
	<?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action('woocommerce_register_form_tag'); ?>>
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<input type="email" placeholder='* כתובת דוא"ל' class="woocommerce-Input woocommerce-Input--text input-text" name="email" id="reg_email" autocomplete="email" value="<?php echo (!empty($_POST['email'])) ? esc_attr(wp_unslash($_POST['email'])) : ''; ?>" /><?php // @codingStandardsIgnoreLine 
																																																																				?>
			</p>
			...
			<?php /*if ('no' === get_option('woocommerce_registration_generate_password')) : ?>
				...
				<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide pass-audit">
					<span class="show-password-input"></span>
					<input type="password" placeholder="* <?php esc_html_e('Password', 'woocommerce'); ?>" class="woocommerce-Input woocommerce-Input--text input-text" name="password" id="reg_password" autocomplete="new-password" />
